...
export default function NewProformaInvoiceClientPage() {
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-background px-6">
        <div className="flex items-center gap-2">
          <Link href="/dashboard/factures/proforma" className="flex items-center gap-2">
            <Button variant="outline" size="icon" className="h-8 w-8">
              <ArrowLeft className="h-4 w-4" />
            </Button>
          </Link>
          <h1 className="text-xl font-semibold">Nouvelle Facture Proforma</h1>
        </div>
                  ...
                  <div className="space-y-6 lg:col-span-2">
                    <Card>
                      <CardHeader className="pb-3">
                        ...
                        <CardDescription>Informations de base pour la facture proforma</CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="invoiceNumber" placeholder="PRO-2023-001" />
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="space-y-6 lg:col-span-2">
                    <Card>
                      <CardHeader className="pb-3">
                        ...
                        <CardDescription>Ajoutez les articles à inclure dans la facture proforma</CardDescription>
                      </CardHeader>
                      <CardContent>
                  ...
                  <div className="space-y-6 lg:col-span-2">
                    <Card>
                      <CardHeader className="pb-3">
                        ...
                        <CardDescription>Ajoutez une garantie à cette facture proforma</CardDescription>
                      </CardHeader>
                      <CardContent>
      ...
      <Dialog open={isSelectGuaranteeOpen} onOpenChange={setIsSelectGuaranteeOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Choisissez une garantie existante à associer à cette facture proforma.
            </DialogDescription>
          </DialogHeader>
