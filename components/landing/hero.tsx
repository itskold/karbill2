      ...
      <div className="container px-4 md:px-6 relative">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            <span>3000+ garages nous font confiance</span>
          ...
          >
            Simplifiez la gestion de votre garage automobile
          </motion.h1>
          ...
          >
            Karbill est le logiciel tout-en-un pour les garages automobiles en Belgique. Gérez vos clients, véhicules,
            factures et plus encore.
          </motion.p>
          ...
          >
            <div className="bg-white rounded-lg shadow-lg p-3 border border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm font-medium">Facture créée</div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="bg-white rounded-lg shadow-lg p-3 border border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm font-medium">Client ajouté</div>
              </div>
            </div>
          </div>
        </motion.div>
