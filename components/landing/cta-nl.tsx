      ...
      <div className="container px-4 md:px-6 relative">
        ...
        >
          ...
          <div className="relative z-10 px-6 py-16 md:px-12 md:py-24 text-center">
            ...
            >
              Klaar om het beheer van uw garage te vereenvoudigen?
            </motion.h2>
            ...
            >
              Sluit u aan bij duizenden professionals die vertrouwen op Karbill om hun dagelijkse activiteiten te
              beheren.
            </motion.p>
